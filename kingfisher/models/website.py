...
class WebsiteMenu(models.Model):
    ...
    megamenu_bg_image_filename = fields.Char("Background image for megamenu Filename")
    megamenu_bg_image_id = fields.Integer("Background image for megamenu id")
    ...
    def create(self, vals):
        if vals.get('megamenu_bg_image'):
            ir_attach_obje = self.env['ir.attachment']
            ir_att_id = ir_attach_obje.create({
                'name': vals.get('megamenu_bg_image_filename'),
                'type': 'binary',
                'res_model': 'website.menu',
                'datas': vals.get('megamenu_bg_image'),
                'datas_fname': vals.get('megamenu_bg_image_filename'),
            })
            vals['megamenu_bg_image_id'] = ir_att_id.id
